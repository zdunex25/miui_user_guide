...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (jezyk.contains("pl")) {
            ...
            //Toast.makeText(MainActivity.this, "This app has been designed for MIUIPolska and since you are not using PL locale, app icon will disappear from launcher soon.", Toast.LENGTH_LONG).show();
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if(tutuly[i].equals("Aktualizacje")){
                ...
                } else if(tutuly[i].equals("Oszczędzanie baterii")){
					showDialog(getResources().getString(R.string.battery), getResources().getString(R.string.battery_summary));
                    ...
                    if (device.matches("mocha|latte")) {
                        ...
                        sendBroadcast(new Intent("android.provider.Telephony.SECRET_CODE", Uri.parse("android_secret_code://6484")));
                    }
                    ...
                    if (usbCharge) {
                        if (Build.VERSION.SDK_INT >= 23) {
                            //cannot use due to lack of permissions for user app
                            //usb.setClassName("com.android.settings", "com.android.settings.deviceinfo.UsbModeChooserActivity");
                            Toast.makeText(MainActivity.this, "W Android 6.0 do wyboru w belce powiadomień!", Toast.LENGTH_LONG).show();
                        } else {
        ...
        btnOpenPopup.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (density >= 4.0) {
                    ...
                    if (device.matches("mocha|latte")) {
                        popupWindow.showAsDropDown(btnOpenPopup, 50, -160);
                    } else {
